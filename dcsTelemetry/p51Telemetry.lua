...
function LuaExportStart()
    ...
    logEvent("=========== Mission Start ," .. version .. ", Pilot: " .. pilot)
end
...
function getTelemetry()
    ...
    mm2inch = 0.0393701
    data = {}
    data.IAC = round(LoGetIndicatedAirSpeed() * mps2mph, 0) -- (args - 0, results - 1 (m/s))
    ...
    data.AOA = round(LoGetAngleOfAttack() * rad2deg, 1) -- (args - 0, results - 1 (rad))
    ...
    data.warEmergencyPowerLimWire = mainPanel:get_argument_value(190)
